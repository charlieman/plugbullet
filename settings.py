# Django settings for plugbullet project.
...
DATABASE_NAME = 'bullet.db'         # Or path to database file if using sqlite3.
...
SECRET_KEY = 'm8u5oe_7xb0s(su-)ep6hfxe(ifg&a$xlspb3vei$ss%-a$%ep'
